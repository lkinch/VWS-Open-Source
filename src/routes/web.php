...
Route::get('/dashboard/surveys/appendices/surveyAppendixQ/index.html?SurveyList={SurveyListId}', [AppendixQController::class,'index'])->name('AppendixQ');
...
Route::get('/dashboard/availableSurveys', [SurveyController::class, 'availableSurveys'])->name('availableSurveys');
