		...
		<section class="right-panel" >
            <form id="distributeForm" action="{{ route('DistributeSurveyStore') }}" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    class="form-control" value="My First Distribution of Survey" placeholder="Study Distribution Name" aria-label="Study distribution name" aria-describedby="button-addon1">
                </div>
