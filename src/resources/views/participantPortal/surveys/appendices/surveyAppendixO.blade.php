@section('surveyAppendixO')
    ...
    <div class='survey'>
            @csrf
            <div class="mb-3">
                <label for="age" class="form-label">{{ $questions[0] }}</label>
            ...
            <div class="mb-3" id='gender'>
                <label for="gender" class="form-label">{{ $questions[1] }}</label>
            ...
            <div class="mb-3">
                <label for="height" class="form-label">{{ $questions[2] }}</label>
            ...
            <div class="mb-3">
                <label for="weight" class="form-label">{{ $questions[3] }}</label>
            ...
            <div class="mb-3">
                <label for="occupation" class="form-label">{{ $questions[4] }}</label>
            ...
            <div class="mb-3">
                <label for="workSituation" class="form-label">{{ $questions[5] }}</label>
            ...
            <div class="form-group">
                <label for="chronic">{{ $questions[6] }}</label>
