@section('surveySocialWorkout')
    ...
    <div class='survey'>
            ...
            <div class="question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 1) Family: Exercised with me.</label>
                 <input name="question1" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(0)">
             ...
             <div class="mb-3 question range-slider" id='question1'>
                 ...
                 <input name="question2" type="range" class="range-slider__range" min="1" max="5" value ="5" step="1" id="customRange1" onchange="updateQuestion(1)">
                 <span class="range-slider__value">5</span>
 			</div>

             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 2) Family: Offered to exercise with me.</label>
                 <input name="question3" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(2)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 2) Friends: Offered to exercise with me.</label>
                 <input name="question4" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(3)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
                 ...
                 <input name="question5" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(4)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
                 ...
                 <input name="question6" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(5)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 4) Family: Gave me encouragement. to stick with my exercise program.</label>
                 <input name="question7" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(6)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 4) Friends: Gave me encouragement. to stick with my exercise program.</label>
                 <input name="question8" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(7)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 5) Family: Changed their schedule so we could exercise together.</label>
                 <input name="question9" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(8)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 5) Friends: Changed their schedule so we could exercise together.</label>
                 <input name="question10" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(9)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 6) Family: Discussed exercise with me.</label>
                 <input name="question11" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(10)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 6) Friends: Discussed exercise with me.</label>
                 <input name="question12" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(11)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 7) Family: Complained about the time I spend exercising.</label>
                 <input name="question13" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(12)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 7) Friends: Complained about the time I spend exercising.</label>
                 <input name="question14" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(13)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 8) Family: Criticized me or made fun of me for exercising.</label>
                 <input name="question15" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(14)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 8) Friends: Criticized me or made fun of me for exercising.</label>
                 <input name="question16" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(15)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
                 ...
                 <input name="question17" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(16)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
                 ...
                 <input name="question18" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(17)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 10) Family: Planned for exercise on recreational outings.</label>
                 <input name="question19" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(18)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 10) Friends: Planned for exercise on recreational outings.</label>
                 <input name="question20" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(19)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 11) Family: Helped plan activities around my exercise.</label>
                 <input name="question21" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(20)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 11) Friends: Helped plan activities around my exercise.</label>
                 <input name="question22" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(21)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 12) Family: Asked me for ideas on how they can get more exercise.</label>
                 <input name="question23" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(22)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 12) Friends: Asked me for ideas on how they can get more exercise.</label>
                 <input name="question24" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(23)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 13) Family: Talked about how much they like to exercise.</label>
                 <input name="question25" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(24)">
                 <span class="range-slider__value">5</span>
 			</div>
             <div class="mb-3 question range-slider" id='question1'>
 				<label for="customRange1" class="form-label"> 13) Friends: Talked about how much they like to exercise.</label>
                 <input name="question26" type="range" class="range-slider__range" min="1" max="5" value="5" step="1" id="customRange1" onchange="updateQuestion(25)">
                 <span class="range-slider__value">5</span>
 			</div>
