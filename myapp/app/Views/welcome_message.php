...
<head>
    ...
    <link rel="stylesheet" href="/static/welcome_message/css/style.css" />
...
<body>
    <nav class="nav">
        <div class="container">
            <h1 class="logo"><a href="/index.html">Virtual Wellness System</a></h1>
            <ul>
    ...
    <div class="hero">
        <div class="container">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, quis.</p>
        </div>
    </div>
	...
	<script src="/static/welcome_message/js/script.js"></script>
</body>
